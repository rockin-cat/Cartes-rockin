...
window.ROCKIN_DADES = (function () {
  ...
  const BINARI = [
    ...
    R("mb19", "Binari", "xE Q Q Q"), R("mb20", "Binari", "Ex Q Q R"), R("mb21", "Binari", "Ex xE Ex xE"),
    R("mb22", "Binari", "Q xE Q Q"), R("mb23", "Binari", "Q xE Q R"), R("mb24", "Binari", "Q Ex Q Ex"),
  ...
  const TERNARI = [
    ...
    R("mt10", "Ternari", "H3"), R("mt11", "Ternari", "EE EE EE"), R("mt12", "Ternari", "Q Q Ex"),
    R("mt13", "Ternari", "xE Q Q"), R("mt14", "Ternari", "xE EE xE"), R("mt15", "Ternari", "Q EE Ex"),
    ...
    R("mt22", "Ternari", "xE xE xE"), R("mt23", "Ternari", "Q Ex Q"), R("mt24", "Ternari", "xE Q R"),
    R("mt25", "Ternari", "Ex Q Ex"), R("mt26", "Ternari", "SES SES SES"),
  ...
  const MELODIC = [
    ...
    M(12, [[0, 1, 2], [0, 1, 2], [0, 1, 2], [0, 1, 2]]),
    M(13, [[2, 1, 0], [2, 1, 0], [2, 1, 0], [2, 1, 0]]),
    M(14, [[0, 1, 2, 3], [0, 1, 2, 3]]),
    M(15, [[0, 1, 2, 3], [0, 1, 2, 3]]),
    M(16, [[0, 1, 2, 3], [0, 1]]),
    M(17, [[3, 2, 1, 0], [3, 2, 1, 0]]),
    M(18, [[3, 2, 1, 0], [3, 2, 1, 0]]),
    M(19, [[3, 2, 1, 0], [2, 1]]),
    M(20, [[0, 3, 1, 3]]),
    M(21, [[0, 1, 2], [0, 1, 2], [0, 1, 2]]),
    M(22, [[2, 1, 0], [2, 1, 0], [2, 1, 0]]),
    M(23, [[0, 1], [1, 0]]),
    M(24, [[3, 0, 1, 0]]),
    M(25, [[1, 0], [0, 1]]),
    M(26, [[0, 0], [1, 1]]),
